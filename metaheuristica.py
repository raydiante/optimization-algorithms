...
def vizinhanca(arv,card,nvizi):
	...
	while flag==0:
		...
		#a=result[0]
		print ordem
		a=random.randint(0,len(ordem)-1)
...
def metaheuristica(matriz,card): # grasp como construtivo e vns
